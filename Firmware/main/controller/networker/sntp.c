...
#define CONFIG_SNTP_TIME_SERVER_1 "cn.ntp.org.cn"
#define CONFIG_SNTP_TIME_SERVER_2 "pool.ntp.org"
...
struct tm getTimeInfo(void)
{
    ...
    if (sntp_get_sync_mode() == SNTP_SYNC_MODE_SMOOTH)
    {
        ...
        while (sntp_get_sync_status() == SNTP_SYNC_STATUS_IN_PROGRESS)
        {
            ...
            ESP_LOGW(TAG, "Waiting for adjusting time ... outdelta = %jd sec: %li ms: %li us",
